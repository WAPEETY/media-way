                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="mt-3 text-center sm:mt-0 sm:mx-2 sm:text-left">
                            ...
                            <div className="grid grid-cols-2 gap-2 space-y-1 mt-8">
                                ...
                                <label className="text-gray-400">data inizio:</label><input type="datetime-local" value={startDay}  onChange={event => setStartDay(event.target.value)} className="col-span-2 border-2 rounded-full px-3 py-2 w-full bg-white text-gray-700 focus:outline-none focus:border-blue-400 focus:shadow" />
